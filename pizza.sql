...
create table Person(name varchar(20), age integer, gender varchar(20));
create table Frequents(name varchar(20), pizzeria varchar(20));
create table Eats(name varchar(20), pizza varchar(20));
create table Serves(pizzeria varchar(20), pizza varchar(20), price decimal);
